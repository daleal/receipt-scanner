...
METADATA="$BASEDIR/receipt_scanner/__init__.py"
...
git add $BASEDIR/pyproject.toml $BASEDIR/receipt_scanner/__init__.py &&
git switch --create release/prepare-$NEW_VERSION &&
